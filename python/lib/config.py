...
settings = {                                                      # All settings are stored in this dict
    ...
    "configuration":{  # Program configuration
                     ...
                     'MAX_BRIGHTNESS': 150,                       # Frequencies above this value will be removed during audio processing
    ...
    "devices":{
               ...
               #                        "UDP_IP": "192.168.0.120",                   # IP address of the ESP8266. Must match IP in ws2812_controller.ino
               #                        "UDP_PORT": 7778,                            # Port number used for socket communication between Python and ESP8266
               #                        "MAX_BRIGHTNESS": 200,                       # Max brightness of output (0-255) (my strip sometimes bugs out with high brightness)
               #                          # Other configuration
               ...
               #                                     "reverse_roll": False,           # Reverse movement of gradient roll
               #                                     "flip_lr":False},                # Flip output left-right
               #                       "Gradient":  {"color_mode":"Fruity",         # Colour gradient to display
               #                                     "roll_speed": 1,                 # How fast (if at all) to cycle colour colours across strip
